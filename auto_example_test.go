...
import (
	...
	_ "github.com/daboyuka/kooky/browser/all" // This registers all cookiestore finders!
	// _ "github.com/daboyuka/kooky/browser/chrome" // load only the chrome cookiestore finder
)
